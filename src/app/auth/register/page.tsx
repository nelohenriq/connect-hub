...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-pink-50 to-blue-50 flex items-center justify-center px-4 py-8">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Join ConnectHub and start your dating journey today
            </CardDescription>
          </CardHeader>
          <CardContent>
